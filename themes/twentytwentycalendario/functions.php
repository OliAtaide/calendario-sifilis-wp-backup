<?php
/**
 * Twenty Twenty Calendario functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package WordPress
 * @subpackage Twenty_Twenty
 * @since Twenty Twenty Calendario 1.0
 */
...
function twentytwenty_theme_support() {
	 ...
	 * If you're building a theme based on Twenty Twenty Calendario, use a find and replace
...
function twentytwenty_get_elements_array() {
	...
	/**
	 * Filters Twenty Twenty Calendario theme elements.
	 *
	 * @since Twenty Twenty Calendario 1.0
	 *
...
add_action( 'wp_enqueue_scripts', 'themebs_enqueue_styles', 99);
